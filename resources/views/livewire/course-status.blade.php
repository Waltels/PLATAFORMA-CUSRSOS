<div class="mt-8">
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="card">
            <div class="card-body">
                <h1 class="text-2xl leading-8 text-center mb4" >{{$course->title}}</h1>
                <div class="flex items-center">
                    <figure class="mr-3">
                        <img class="w-12 h-12 objet-cover rounded-full mr-4" src="{{$course->teacher->profile_photo_url}}" alt="">
                    </figure>
                    <div>
                ...
                <ul>
                    @foreach ($course->sections as $section)
                        <li class="text-gray-600 mb-2">
                            <a class="font-bold text-base nline-mb-4" href="">{{$section->name}}</a>
                            <ul>
