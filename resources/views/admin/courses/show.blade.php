    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
              ...
              @else
              <img class="h-60 w-full objet-cover" src="https://www.pexels.com/photo/5965857/download/" alt="">
              @endif
            </figure>
        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-3">
                <div class="card-body">
                    ...
                    <a class="btn btn-danger w-full block text-center mt-2" href="{{route('admin.courses.observation', $course)}}">Observar curso</a>
                </div>
            </section>
        </div>
    </div>
